...
<div id="description">
    ...
    <br>
    <br>
    <p>The car details page's content block includes:</p>
        <ul>
    ...
    <br>
    <br>
    <p>The content block on the registration page contains a form for filling out information and a "Registration" button.</p>
